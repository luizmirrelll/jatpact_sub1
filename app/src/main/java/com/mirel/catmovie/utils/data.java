...
public class data {
    public static ArrayList<Film> generateDummyFilms() {
    ...
    public static ArrayList<TiviLoc> generateDummyTivi() {

        ArrayList<TiviLoc> tiviseries = new ArrayList<>();

        tiviseries.add(new TiviLoc(
                "1",
                "Shameless (2011)",
